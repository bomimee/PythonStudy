...
#2. 이 각각의 열에 대한 이름을 키로 가지고 있는 딕셔너리만들기
#3. 이 데이터를 데이터프레임 생성자에 넣기
...
print(df3)
df4 = DataFrame({"name": ["뽀로로", "패디", "크롱", "루피", "에디"], "id" :["pororo", "paty", "cron", "rupy", "edi"]}, index=["no_1","no_2","no_3","no_4","no_5",])
print(df4)
