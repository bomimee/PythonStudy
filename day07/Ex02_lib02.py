...
"""
    ...
    os.popen : 시스템 며령어를 시킨 결과값을 읽기 모드의 파일 객체로 돌려 준다.     
    os.path.dirname(__file__)  : 현재 위치 저장
    os.mkdir(디렉토리명) : 디렉토리 생성
    os.rmdir(디렉토리명) : 디렉토리 삭제 (비어있어야 한다.)
    os.rename(원본파일이름,변경할파일이름)
"""
# shutil : 파일복사해주는 모듈
...
print(os.path.dirname(__file__) ) # 현재 위치
print(os.getcwd())
